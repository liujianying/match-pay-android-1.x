...
import com.fintech.match.pay.service.job.MyJobService;

public class JobServiceCompact {

    //启动心跳
    public static void startJob(Context context, int delayMillis) {
        JobInfo.Builder builder = new JobInfo.Builder(1001, new ComponentName(context, MyJobService.class));
